...
This module contains the configuration and functions for running database migrations
using Alembic. It supports both online and offline migration modes.
"""
...
def run_migrations_offline() -> None:
    ...
    """
    # Get the database URL from the db_config module
